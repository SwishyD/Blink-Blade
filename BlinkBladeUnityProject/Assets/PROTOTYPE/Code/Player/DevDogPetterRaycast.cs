...
public class DevDogPetterRaycast : MonoBehaviour
{
    public LayerMask rayMask;
    [SerializeField] PetTheDevDog[] dogPetScripts;
    ...
    void FixedUpdate()
    {
        ...
        if (hit.collider != null)
        {
            ...
            {
                hit.collider.gameObject.GetComponent<PetTheDevDog>().SetDogPettability(true);
