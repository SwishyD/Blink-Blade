...
public class PlayerJumpV2Mirror : MonoBehaviour
{
    ...
    public static PlayerJumpV2Mirror instance = null;
    ...
    private void OnEnable()
    {
        ...
        PlayerJumpV2.instance.enabled = false;
    }

    private void OnDisable()
    {
        this.gameObject.transform.rotation = Quaternion.Euler(0, 0, 0);
        PlayerJumpV2.instance.enabled = true;
    }
